...
class MistralAttention(nn.Module):
    ...
    def __init__(self, config: MistralConfig, layer_idx: Optional[int] = None):
        ...
        self.k_proj = convert_linear_to_moe("k_proj", config, layer_idx, self.hidden_size, self.num_key_value_heads * self.head_dim, bias=False)
        self.v_proj = convert_linear_to_moe("v_proj", config, layer_idx, self.hidden_size, self.num_key_value_heads * self.head_dim, bias=False)
