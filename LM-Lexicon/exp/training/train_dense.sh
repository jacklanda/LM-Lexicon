    ...
    #for dataset in "wiki"
        ...
        do
            ...
            nohup ./run.sh \
                ...
                --data_path_train /home/ivanfung/workspace/LM-Lexicon/sift/dataset/${dataset}/clustered/${cluster}/train.jsonl \
                ...
                --output_dir /data2/checkpoints/results/${model_name_suffix}-${dataset}-${cluster} \
                ...
                --logging_steps 10 \
                --grad_accumulation_steps 1 > logs/${model_name_suffix}-${dataset}-${cluster}.log 2>&1 &
